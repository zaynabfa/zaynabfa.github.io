...
nav: true
nav_order: 4
cv_pdf: zaynab_azeem_cv.pdf
---

## Education

**Honors Bachelors of Science (HBSc) with Co-op**  
Specialist in Neuroscience (Systems and Behavioural Systems), Minor in Applied Statistics  
...
- Investigating the geometry and topology of face representations, focusing on how different race categories are organized in representational manifolds
- Applying Riemannian metrics and similarity-structure analyses to evaluate clustering, separability, and continuity in face spaces
- Developing and adapting computational pipelines to compare manifold structures across participant groups and datasets
...
- Designing and leading a mixed-methods study on laboratory learning experiences among students with and without formal academic accommodations
- Developing and distributing survey instruments to capture barriers, supports, and accessibility needs across STEM departments
- Preparing Research Ethics Board (REB) protocol, including detailed procedures, rationale, and participant protections
...
- Helped design and conducted a thesis project reconstructing faces from EEG signals using StyleGAN2 and representational similarity mapping
- Set-up and collected whole-brain EEG data from 20+ participants
- Developed a neural-guided GAN pipeline integrating brain–image similarity structures to enable high-fidelity face reconstructions
- Achieved a final grade of 98%, ranking among the top theses in the department
- Demonstrated methodological innovation by applying latent space similarity mapping to bridge EEG data with generative AI models
...
- Assisted with MATLAB coding for data preprocessing and analysis, including trial structure and output formatting
- Contributed to lab operations, including experiment teardown and equipment maintenance
...
- Led the first in vivo quantification of CSF lymphatic drainage in a NASA hindlimb unloading (HU) mouse model of microgravity
- Designed and executed experimental protocols involving fluorescent tracer injections and tissue analysis to track drainage pathways
- Analyzed drainage efficiency and lymphatic clearance rates using advanced imaging and quantitative methods
- Funded by the University of Toronto Research Opportunity Award ($2,500)
...
- Developing signal processing pipelines in MATLAB to analyze EEG–sEMG recordings during rest, plantarflexion, and dorsiflexion
- Computing RMS-normalized EMG (%MVC) and modeling corticomuscular coherence (CMC) and phase–amplitude coupling (PAC) to examine neural–muscular communication
...
- Observed intracerebroventricular (ICV) infusions, clamp procedures, and stereotaxic surgeries in antipsychotic mouse studies
- Supported a PhD project on EVLT and neurocognitive deficits in schizophrenia by designing and managing an SPSS database to streamline data collection
...
- **University of Toronto Excellence Award (UTEA)**, $7,500 (2024)
- **University of Toronto Research Opportunity Award (UROA)**, $2,500 (2024)
- **Canadian Space Health Research Symposium Travel Award** (2024)
- **LMP Best Poster** (2024)
- **URS Best Poster** (2024)
- **Budding Scholars Award** (2022)
- **Deans List** (2021-2025)
- **Entrance Scholarship** (2021)
